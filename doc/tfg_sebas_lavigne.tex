...
\label{sec:descripcion}
	...
	Está publicado en la plataforma \textit{GitHub}\footnote{Alojado en el repositorio \href{https://github.com/SebLavK/java-untersee}{https://github.com/SebLavK/java-untersee}} bajo la Licencia Pública General de GNU, \textit{GPLv3}\footnote{Más información sobre la licencia en \href{https://www.gnu.org/licenses/gpl-3.0.en.html}{https://www.gnu.org/licenses/gpl-3.0.en.html}}.
	
	\vspace{5cm}
	\begin{figure}[h]
		\centering
		\includegraphics[angle=270,origin=c,width=0.5\textwidth]{img/sub0.png}
		\label{fig:submarine}
	\end{figure}
...
\label{sec:desc_tecnica}
	...
	\label{subsec:motor_grafico}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[width=\textwidth]{img/untersee_screenshot.png}
			\caption{La ventana del juego.1. Pantalla de mapa. 2. Pantalla de información. 3. Consola del jugador.}
			\label{fig:ventana}
		\end{figure}
		...
		\paragraph{La pantalla de mapa}
			...
			\begin{figure}[h]
				...
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[width=.9\linewidth]{img/untersee_real.png}
				\end{minipage}%
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[width=.9\linewidth]{img/untersee_strategy.png}
				\end{minipage}
				\caption{Comparación de la vista \textit{real} (izquierda) y la vista \textit{estratégica} (derecha).}
			\end{figure}
			\vfill
	...
	\label{subsec:interprete_comandos}
		...
		\paragraph{El Parseador}
			...
			Se puede observar el camino de estos ejemplos en la \nameref{fig:parseador}, en la página \pageref{fig:parseador}.
			
		\begin{figure}[p]
			\centering
			\includegraphics[width=\textwidth]{img/parseador.pdf}
...
\onehalfspacing
	...
	\begin{labeling}{\textbf{IntelliJ IDEA}}
		...
		\item[\textbf{draw.io}]Editor web de diagramas y gráficos.
	\end{labeling}
